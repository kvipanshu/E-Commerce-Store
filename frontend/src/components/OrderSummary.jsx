...
const stripePromise = loadStripe(
	"pk_test_51PuEo1FGRV5zHUax20pz6ugeTva30O07xPEaMx71ZDcVniTHGjK0OK8cPCGcQBk75UNKtRwR3YnM38f3xp8NP7Ek00NVtRZ1tH"
);
			...
			<div className="space-y-4">
				<div className="space-y-2">
					...
					<dl className="flex items-center justify-between gap-4 border-t border-gray-600 pt-2">
						...
						<dd className="text-base font-bold text-slate-400">
							${formattedTotal}
						</dd>
					</dl>
				</div>
				...
				<div className="flex items-center justify-center gap-2">
					...
					<Link
						to="/"
						className="inline-flex items-center gap-2 text-sm font-medium text-slate-400 underline hover:text-slate-300 hover:no-underline"
					>
						Continue Shopping
						<MoveRight size={16} />
					</Link>
